    ...
    chrome.runtime.onMessage.addListener(
      function(request, sender, sendResponse) {
        ...
        if (request.type === 'openNewTab') {
           ...
           chrome.tabs.create({"url": "html/prod_table.html"},function(tab){

               chrome.tabs.sendMessage(sender.tab.id, {type : "getProductsData"}, function(resp){

                    chrome.tabs.sendMessage(tab.id, {type : "productsData",content : resp.content}, function(resp){
